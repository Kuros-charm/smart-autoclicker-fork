...
@OpenForTesting
@WorkerThread
internal class Cache(private val bitmapSupplier: (String, ByteArray, Int, Int) -> Bitmap?) {
    ...
    val pixelsCache: LruCache<Condition, Pair<IntArray, IntArray>?> = object
        ...
        override fun create(condition: Condition): Pair<IntArray, IntArray>? {
            ...
            val conditionBitmap = bitmapSupplier.invoke(condition.path!!,condition.bitmapByteArray!!, condition.area.width(), condition.area.height()) ?: return null
