...
interface Repository {
    ...
    companion object {
        ...
        public val DB_NAME = "click_database"
        ...
        fun getRepository(context: Context): Repository {
            return INSTANCE ?: synchronized(this) {
                val instance = RepositoryImpl(ClickDatabase.getDatabase(context, DB_NAME), BitmapManagerImpl(context.filesDir))
                INSTANCE = instance
                instance
            }
        }
     ...
     */
    suspend fun getBitmap(id: String,byteArray: ByteArray,  width: Int, height: Int): Bitmap?
