...
data class Event(
    ...
    var minDelay: Int? = null,
) {

    /** @return the entity equivalent of this event. */
    internal fun toEntity() = EventEntity(id, scenarioId, name, conditionOperator, priority, stopAfter, minDelay)
...
internal fun EventEntity.toEvent() = Event(id, scenarioId, name, conditionOperator, priority, stopAfter = stopAfter, minDelay= minDelay)
