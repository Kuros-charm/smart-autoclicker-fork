...
fun newDefaultInput(context: Context, eventId: Long) = Action.Input(
    eventId = eventId,
    name = context.getString(R.string.default_input_name),
    text = ""
)
fun newDefaultButton(context: Context, eventId: Long) = Action.ButtonPress(
    eventId = eventId,
    name = context.getString(R.string.default_button_name),
    button = ButtonPressType.HOME
)
